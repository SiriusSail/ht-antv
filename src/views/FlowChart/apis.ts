...
// 节点类型枚举
type BigType = "MODEL_TYPE_VARIABLE " | "MODEL_TYPE_NODE" | "MODEL_TYPE_OUTPUT" | "MODEL_TYPE_INPUT"
...
export default {
  数据开发左侧列表: axiosApiHooks(() => request<InitModelInfo>({
    url: '/ddm-iic/flow/ddmflow/initModelInfo',
    method: 'get',
    json: true,
  })),

  数据源列表: axiosApiHooks(() => request<DataSourceResType[]>(
    {
  ...
  数据源列表2: () => request<DataSourceResType[]>(
    {
      url: '/ddm-iic/flow/inddatasource/list',
      method: 'get',
      json: true,
  ...
  新增数据源: axiosApiHooks((data: CreateDataSourceResType) => request({
  ...
  修改数据源: axiosApiHooks((data: DataSourceResType) => request({
    url: '/ddm-iic/flow/inddatasource',
    method: 'put',
    json: true,
    data
  ...
  查询数据源: axiosApiHooks((data: string) => request<DataSourceResType & {
    attributeList: any[]
  }>({
  ...
  数据资产列表: axiosApiHooks(() => request<IndassetDatabaseType[]>(
    {
  ...
  原子指标列表: axiosApiHooks(() => request<DdmflowQueryListType[]>(
    {
  ...
  业务指标列表: axiosApiHooks(() => request<DdmflowQueryListType[]>(
    {
  ...
  衍生指标列表: axiosApiHooks(() => request<DdmflowQueryListType[]>(
    {
  ...
  获取源数据资产列表: axiosApiHooks<string, ColumnDataType[]>((datasourceId) => request(
    {
  ...
  删除指标: axiosApiHooks((id: string) => request<Pages<DdmflowPageRes>>(
    {
  ...
  新增数据资产: axiosApiHooks((data: any) => request({
  ...
  修改数据资产: axiosApiHooks((data: any) => request({
    url: '/ddm-iic/flow/indasset',
    method: 'put',
    json: true,
    data
  ...
  查询领域: axiosApiHooks(() => request<DomainItem[]>({
    url: '/ddm-iic/help/iichelp/domain',
    method: 'get',
    json: true,
  })),
  ...
  数据卡片列表: axiosApiHooks(() => request<IicindcardItem[]>(
    {
  ...
  获取数据卡片: (data: IndassetDatabaseType) => request({
  ...
  修改数据卡片: (data: IndassetDatabaseType) => request({
    url: '/ddm-iic/datasource/iicindcard',
    method: 'put',
    json: true,
    data
  ...
  查询数据卡片: (data: string) => request<IndassetDatabaseType>({
    url: `/ddm-iic/datasource/iicindcard/${data}`,
    method: 'get',
    json: true,
  }).then((res) => res.result),
  删除数据卡片: (rowId: string[]) => request({
    url: '/ddm-iic/datasource/iicindcard',
    method: 'delete',
    json: true,
    data: {
  ...
  获取指标数据: axiosApiHooks((rowId: string) => request<DdmflowInfo>({
    url: `/ddm-iic/flow/ddmflow/${rowId}`,
    method: 'get',
    json: true,
  })),
  获取指标领域: axiosApiHooks(() => request<{
    dictLabel: string;
    dictValue: string;
  }[]>({
