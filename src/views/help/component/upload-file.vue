  ...
  <div class="upload-file-box">
    ...
    <div class="upload-file-con">
      <div class="item" v-for="item in fileList" :key="item.uid">
        ...
        <div class="operation">
          <i class="icon el-icon-download" v-if="item.state == 'success'"></i>
          <i class="icon el-icon-view" v-if="item.state == 'success'"></i>
          <div>
            <i class="icon el-icon-warning" v-if="item.state == 'fail'"></i>
