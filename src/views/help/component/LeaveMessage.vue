  ...
  <div class="LeaveMessage">
    ...
    <div class="message-con">
      <div class="commonlyUsed">
        <div v-if="showComponent" class="commonly-item disable">
          <span class="pointer">组件推荐</span>
        </div>
        <div v-if="showIndicator" class="commonly-item disable">
          <span class="pointer">指标推荐</span>
        </div>
        <!-- <div class="commonly-item">指标推荐</div> -->
