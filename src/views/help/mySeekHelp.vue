<template>
  <div class="addHelp">
    <el-row :gutter="20">
      <el-col :span="18">
        <MyForm ref="formRef" :form="form" :list="formList" label-position="right" labelWidth="90px">
          <template #messageContent>
            <leave-message @fileChange="fileChange" v-model="form.messageContent" label="发起求助">
            </leave-message>
          </template>
        </MyForm>
        <div class="footer">
          <my-button type="primary" v-if="!rowId" @click="submit()">发起求助</my-button>
          <my-button type="primary" v-else @click="updateHelp()">修改</my-button>
          <my-button @click="returnHome()">返回求助首页</my-button>
          <!-- <my-button @click="storage()">暂存</my-button> -->
