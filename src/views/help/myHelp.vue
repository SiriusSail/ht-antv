<template>
  <div class="MyHelp">
    <div class="statistical">
      <el-row :gutter="20">
        <el-col :span="6">
          <Statisticalcard title="我的求助统计" :list="statisticalList1" />
        </el-col>
        <el-col :span="6">
          <Statisticalcard title="我的帮助统计" :list="statisticalList2" />
        </el-col>
        <el-col :span="6">
          <Statisticalcard title="完成情况统计" :list="statisticalList3" />
        </el-col>
        <el-col :span="6">
          <Statisticalcard title="未完成情况统计" :list="statisticalList4" />
        </el-col>
      </el-row>
    </div>
    <div class="help-con">
          ...
          >
            <template #status="{ data }">
              <div class="state-con">
                ...
                <div v-else class="tag default">暂存</div>
              </div>
            </template>
