<template>
  <div class="Dashboard">
    ...
    <el-row :gutter="20">
      <el-col :span="6">
        <DashboardCard label="指标在线量" icon="el-icon-warning-outline" body-border height="140px">
          <template #body>
            <div class="online">
              <div class="count">
      ...
      <el-col :span="6">
        <DashboardCard label="指标月访问量" icon="el-icon-warning-outline" body-border height="140px">
          <template #body>
      ...
      <el-col :span="6">
        <DashboardCard label="指标开发走势" icon="el-icon-warning-outline" body-border height="140px">
          <template #body>
      ...
      <el-col :span="6">
        <DashboardCard label="指标评审态势" icon="el-icon-warning-outline" body-border height="140px">
          <template #body>
