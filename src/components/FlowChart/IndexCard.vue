<template>
  <div class="IndexCard" @click="href()">
    <div class="chart">
      <h1>{{ item.domain || item.dimension }} <span class="tag">优</span></h1>
      <MyChart class="ring" :option="options"></MyChart>
    </div>
    <div class="info">
      <div class="count">
...
export default defineComponent({
  ...
  setup(props) {
    // const e = 33.3;
    const e = Math.round((props.item.totalOnline / props.item.total) * 100);
    ...
    const href = () => {
      ...
      location.href = "#/IndexCenter/Manage/marketingIndicators";
    };
    return {
      href,
      ...toRefs(state),
